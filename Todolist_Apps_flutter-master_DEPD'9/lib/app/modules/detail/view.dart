...
import 'package:flutter_taskapp/app/modules/detail/widgets/doing_list.dart';
import 'package:flutter_taskapp/app/modules/detail/widgets/done_list.dart';
                        ...
                        onPressed: () {
                          if (homeCtrl.formKey.currentState!.validate()) {
                            var success = homeCtrl.addTodo(
                              ...
                              homeCtrl.getFormatedDate().toString(),
                              // homeCtrl.dateinput(tanggal).toString(),
                            );
                            if (success) {
